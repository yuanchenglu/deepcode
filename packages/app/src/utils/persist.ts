...
const GLOBAL_STORAGE = "deepcode.global.dat"
const WINDOW_STORAGE = "deepcode.window"
const LOCAL_PREFIX = "deepcode."
...
function workspaceStorage(dir: string) {
  ...
  return `deepcode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `deepcode.draft.${head}.${sum}.dat`
}
