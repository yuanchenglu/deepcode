...
it.instance("plan agent denies edits except .deepcode/plans/*", () =>
  Effect.gen(function* () {
    ...
    expect(Permission.evaluate("edit", ".deepcode/plans/foo.md", plan!.permission).action).toBe("allow")
  }),
)
...
`,
      ...
      process.env.DEEPCODE_TEST_HOME = test.directory
