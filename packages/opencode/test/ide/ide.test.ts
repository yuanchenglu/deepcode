...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEEPCODE_CALLER", () => {
    process.env["DEEPCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEEPCODE_CALLER", () => {
    process.env["DEEPCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEEPCODE_CALLER", () => {
    process.env["DEEPCODE_CALLER"] = "unknown"
