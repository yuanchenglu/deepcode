...
// DeepCode Harness 模块注册 — 9+1 个模块覆盖 14 篇创新论文
import {
  DeepCodePrefixNode,
  DeepCodeConstraintStoreNode,
  DeepCodeConstraintContextNode,
  DeepCodeModelRouterNode,
  DeepCodeReasoningManagerNode,
  DeepCodeIntentRouterNode,
  DeepCodeImmuneSystemNode,
